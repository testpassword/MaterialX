...
class OslColor4TypeSyntax : public OslStructTypeSyntax
{
  public:
    OslColor4TypeSyntax() :
        OslStructTypeSyntax("color4", "color4(color(0.0), 0.0)", "{color(0.0), 0.0}", EMPTY_STRING, EMPTY_STRING, RtOslSyntax::COLOR4_MEMBERS)
    {}
...
const string RtOslSyntax::OUTPUT_QUALIFIER = "output";
const string RtOslSyntax::SOURCE_FILE_EXTENSION = ".osl";
const StringVec RtOslSyntax::VECTOR_MEMBERS  = { "[0]", "[1]", "[2]" };
const StringVec RtOslSyntax::VECTOR2_MEMBERS = { ".x", ".y" };
const StringVec RtOslSyntax::VECTOR4_MEMBERS = { ".x", ".y", ".z", ".w" };
const StringVec RtOslSyntax::COLOR2_MEMBERS  = { ".r", ".a" };
const StringVec RtOslSyntax::COLOR4_MEMBERS  = { ".rgb[0]", ".rgb[1]", ".rgb[2]", ".a" };

//
// OslSyntax methods
//

RtOslSyntax::RtOslSyntax()
{
...
const string& RtOslSyntax::getOutputQualifier() const
{
